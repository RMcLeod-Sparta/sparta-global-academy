...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { availability: @computer.availability, color: @computer.color, name: @computer.name, serial_number: @computer.serial_number } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { availability: @computer.availability, color: @computer.color, name: @computer.name, serial_number: @computer.serial_number } }
